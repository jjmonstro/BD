...
INSERT INTO Fornecedor VALUES 
(2, 4, 'Nokia', 'Av. Afonso Pena', 198, 'Centro', '12000-321', 'Carlos', '94.405.385/0007-35', '123.321.07', '1234-4321');
INSERT INTO Fornecedor VALUES 
(3, 4, 'Gradiente', 'Av. Paraiso', 3654, 'Centro', '12000-321', 'Felipe', '94.405.385/0007-35', '123.321.07', '1234-4321');
INSERT INTO Fornecedor VALUES 
(4, 4, 'Philips', 'Av. Joaquim Gabriel', 24, 'Centro', '12000-321', 'Alex', '94.405.385/0007-35', '123.321.07', '1234-4321');
INSERT INTO Fornecedor VALUES 
(5, 4, 'Politorno', 'Av. Manoel de Nobrega', 156, 'Centro', '12000-321', 'Breno', '94.405.385/0007-35', '123.321.07', '1234-4321');
INSERT INTO Fornecedor VALUES 
(6, 4, 'HP', 'Rua Santa Efigênia', 1092, 'Centro', '12000-321', 'Vanessa', '94.405.385/0007-35', '123.321.07', '1234-4321');
INSERT INTO Fornecedor VALUES 
(7, 4, 'Brastemp', 'Av. Interlagos', 1098, 'Centro', '12000-321', 'Fábio', '94.405.385/0007-35', '123.321.07', '1234-4321');

INSERT INTO Produto VALUES 
(1, 1, 1, 'TV 50" Plasma 600Hz c/ HDMI, Conversor Digital Integrado, Entrada p/ PC e USB 50PJ350 - LG', 39.9, 3);
INSERT INTO Produto VALUES 
(2, 1, 4, 'DVD Player c/ karaokê, Entrada USB e DivX - DVP3520KX - Philips', 1.5, 5);
INSERT INTO Produto VALUES 
(3, 1, 3, 'TV 37" LCD - LCD3730 - (1366 X 768 Pixels) c/ HDTV Ready, Entrada HDMI, Widescreen e Progressive Scan - Gradiente', 3, 2);
INSERT INTO Produto VALUES 
(4, 2, 7, 'Refrigerador Brastemp Ative! Frost Free 403 litros BRM47', 81, 2);
INSERT INTO Produto VALUES 
(5, 2, 7, 'Lavadora e Secadora de Roupa 7kg Ative! BWS24 - Prata - Brastemp', 75, 2);
INSERT INTO Produto VALUES 
(6, 2, 1, 'Forno de Microondas Solo 30 Litros 110V Branco - LG', 15, 4);
INSERT INTO Produto VALUES 
(7, 3, 6, 'Notebook HP G42-245br c/ Intel® Pentium Dual Core T4500 2.3GHz 3GB 320GB DVD-RW Webcam LED 14” Windows 7 Premium - HP', 1.5, 2);
INSERT INTO Produto VALUES 
(8, 3, 6, 'Multifuncional Jato de Tinta Deskjet F4480 (Impressora + Copiadora + Scanner) - HP', 4.9, 4);
INSERT INTO Produto VALUES 
(9, 4, 1, 'LG GT360 Messenger Vermelho - GSM c/ Teclado Qwerty, Câmera 2.0MP c/ zoom 4x, Filmadora, MP3 Player, Rádio FM, Bluetooth Estéreo 2.0, Fone e Cabo de Dados', 0.6, 1);
INSERT INTO Produto VALUES 
...
INSERT INTO Produto VALUES 
(11, 5, 5, 'Mesa Malta Branca - Politorno', 4.9, 4);
INSERT INTO Produto VALUES 
(12, 5, 5, 'Mesa de Estudo Resende - Branca - Politorno', 4.9, 4);
INSERT INTO Produto VALUES 
...
(1, 1, '2010-02-20', '2010-03-01', 1539.01, 720.00, 1, 153.90);
INSERT INTO Entrada VALUES 
(2, 1, '2010-03-13', '2010-04-07', 2984.00, 832.00, 2, 298.40);
INSERT INTO Entrada VALUES 
(3, 1, '2010-03-28', '2010-04-14', 489.00, 218.00, 3, 48.90);
INSERT INTO Entrada VALUES 
(4, 1, '2010-04-27', '2010-04-30', 3982.01, 1023.00, 4, 398.20);
INSERT INTO Entrada VALUES 
(5, 1, '2010-05-19', '2010-05-30', 1827.00, 291.00, 5, 182.70);
INSERT INTO Entrada VALUES 
(6, 1, '2010-06-03', '2010-06-25', 9812.00, 934.00, 6, 981.20);
INSERT INTO Entrada VALUES 
(7, 1, '2010-08-01', '2010-09-01', 19876.00, 1034.00, 7, 1987.60);
